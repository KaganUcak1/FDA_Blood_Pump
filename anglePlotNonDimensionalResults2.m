%% Velocity Plot Non Dimensional Comparision 2
...
hold on;
errorbar((xAxis+1*xAxisScaling)/0.03,avarageData/max(avarageData),stdError,"o-",lw,1.5); 
final =final-1;  start = start -1;
