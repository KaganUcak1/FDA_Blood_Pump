...
myTable = table2array(readtable("./_vectorField/Export_Date=230318_Time=160056nozzleAngleNew1-1/B00001.txt"));
...
axis([-5 30 -30 5])
subplot(1,2,2)
% quiver(myTable(:,1)-1,-myTable(:,2)-16,myTable(:,3),-myTable(:,4),2,"Color","r")
% axis equal
% axis([-5 35 -35 5])
