...
elseif z == 3
    xShift= -1; yShift = -16; axisArray = [-5 30 -27 10];
elseif z == 6
    xShift= -3; yShift = 7; axisArray = [-5 30 -6 28];
elseif z == 5
...
contourf(x2(1:end)+xShift,-y2(1:end)+yShift,Z,30,"LineColor","none")
axis equal
...
hold on; 
quiver(newTable(1:arrowDensity:end,1),newTable(1:arrowDensity:end,2),newTable(1:arrowDensity:end,3),newTable(1:arrowDensity:end,4),2.5,"k","LineWidth",1);
axis equal;axis(axisArray)
title("Angle " +k);
pause(1);
